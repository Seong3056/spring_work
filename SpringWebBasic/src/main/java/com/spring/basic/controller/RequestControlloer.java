...
@Controller
@RequestMapping("/request") //컨트로럴 자체에 공통된 URI 맵핑
public class RequestControlloer {
	public RequestControlloer() {
...
//	@RequestMapping(value = "/request/basic01", method =RequestMethod.POST)
	...
	*/
	...
	/*
	 2. @RequestParam("파라미터 변수명") 값을 받아서 처리할 변수
	    파라미터 변수명과 값을 받을 변수 명을 동일하게 작성하면 @RequestParam 생략 가능
